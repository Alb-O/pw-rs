...
07. [Implementation Checklist](#implementation-checklist) (with phase gates inline)
...
08. [Dependency Graph](#dependency-graph)
09. [Suggested Order](#suggested-order)
...
| **Async stdin breaks pipe input** | Test with \`cat file                         | pw run\`                            |
