...
- [x] Test concurrent message sending (basic coverage in Slice 5; advanced testing deferred to Version 0.2)
...
- [x] Test concurrent requests (basic coverage in Slice 5; advanced scenarios in Version 0.2)
...
- [x] Create `src/object_factory.rs`:
  ...
  - Match on `type_name`:
    ...
    - Future: `"Browser"`, `"BrowserContext"`, `"Page"`, etc. (Version 0.2)
...
**Integration Tests Deferred to Version 0.2:**
These require additional protocol objects and browser launching - see [Version 0.2 Implementation Plan](v0.2-browser-api.md):
...
- [x] README.md updated with Version 0.1 status
